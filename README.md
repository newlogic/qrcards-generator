...
Options:
  --base-url TEXT     Self registration base url e.g https://example.com/reg
  --url TEXT          Self registration url e.g https://example.com/reg/?code=
...
python generate_qr_cards.py --cards 10 --batch 1 --base-url https://ukr.reg.scope.wfp.org/ --url 'https://ukr.reg.scope.wfp.org/ukr/code/?code='

# Generate 2 qr codes with batch 2: 1 pdf with 1 sheet
python generate_qr_cards.py --cards 2 --batch 2 --base-url https://ukr.reg.scope.wfp.org/ --url 'https://ukr.reg.scope.wfp.org/ukr/code/?code='
```
...
docker run -it --rm -v $PWD/output:/app/output newlogic/qrcards_generator --cards 10 --batch 1 --split-by 5 --base-url https://ukr.reg.scope.wfp.org/ --url 'https://ukr.reg.scope.wfp.org/ukr/code/?code=' 
# PDF with PREVIEW
...
QR Cards generator.
================================================================================
Base URL: https://ukr.reg.scope.wfp.org/
URL: https://ukr.reg.scope.wfp.org/ukr/code/?code=
Total cards: 15
...
Save PDF: /app/output/20220329094903/qrcards_batch_10000000_1.pdf
Writing data to PDF.
Generating SVGs.
Preparing PDF sheet number 1.
[card 1].
...
Save PDF: /app/output/20220329094903/qrcards_batch_10000000_2.pdf
```
